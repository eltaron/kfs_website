...
class StatisticPolicy
{
    ...
    {
        return $user->can('delete_any_statistic');
    }
    ...
    {
        return $user->can('force_delete_statistic');
    }
    ...
    {
        return $user->can('force_delete_any_statistic');
    }
    ...
    {
        return $user->can('restore_statistic');
    }
    ...
    {
        return $user->can('restore_any_statistic');
    }
    ...
    {
        return $user->can('replicate_statistic');
    }
    ...
    {
        return $user->can('reorder_statistic');
    }
}
