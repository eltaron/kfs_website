...
class EFinanceService
{
    ...
    function initiatePaymentRequest(array $params, array $mechanism)
    {
        ...
        $url = sprintf(
            "%s?SenderID=%s&RandomSecret=%s&RequestObject=%s&HasedRequestObject=%s",
        ...
        $arr = array(
            ...
            'HasedRequestObject' => $HasedRequestObject
        );
    ...
    function CreateEmptyPaymentMechanismObject($mechanism)
    {
        ...
        if ($mechanism['type'] == "Channel") {
            ...
            $channelPayment->setMobileNumber('01111111111');
    ...
    function SerializePaymentInitiationRequest($obj, $isRoot = True)
    {
        ...
        $str = sprintf(
            ...
            $PaymentConfirmationRedirectUrl
        );
